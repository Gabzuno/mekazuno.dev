...
console.log("Password input:", document.querySelector("#password"));
console.log("Confirm Password input:", document.querySelector("#confirmPassword"));
console.log("Password Feedback:", document.querySelector("#passwordFeedback"));
console.log("Confirm Password Feedback:", document.querySelector("#confirmPasswordFeedback"));

if (password && confirmPassword && passwordFeedback && confirmPasswordFeedback && mainForm) {
