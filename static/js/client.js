...
import { getDatabase, set, ref, onValue, remove } from "https://www.gstatic.com/firebasejs/11.3.0/firebase-database.js";
...
function StaffManagement(idnumber, position, staff_firstname, staff_lastname) {
    ...
    editBtn.innerHTML = "<img src='static/images/icons/edit.png' alt='Edit'> Edit";
    ...
    viewBtn.innerHTML = "<img src='static/images/icons/view.png' alt='View'> View";
    ...
    deleteBtn.innerHTML = "<img src='static/images/icons/delete_user.png' alt='Delete'> Delete";
